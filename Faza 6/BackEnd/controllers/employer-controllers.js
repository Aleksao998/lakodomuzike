...
exports.getEmployer = (req, res, next) => {
	res
		.status(200)
		.json({ success: true, msg: `Show employer ${req.params.id}` });
};
...
exports.updateEmployer = (req, res, next) => {
	res
		.status(200)
		.json({ success: true, msg: `Update employer ${req.params.id}` });
};
...
exports.deleteEmployer = (req, res, next) => {
	res
		.status(200)
		.json({ success: true, msg: `Delete employer ${req.params.id}` });
};
